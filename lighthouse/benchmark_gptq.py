...
def parse_arguments():
    ...
    parser.add_argument("--num-batches", type=int, default=10, help="")
    ...
    parser.add_argument("--sweep", action="store_true", help="Use the parameter ranges for (batch_size, prompt_length, new_tokens) defined in the .py file instead of the CLI ones.")
    ...
    parser.add_argument("--revision", default=None, help="Revision of the model to benchmark")
